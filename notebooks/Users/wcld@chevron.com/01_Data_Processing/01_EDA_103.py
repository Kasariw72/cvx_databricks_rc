...
# MAGIC %fs
# MAGIC cp dbfs:/mnt/Exploratory/WCLD/dataset/RC_T_MAIN_DATA_01.zip file:/databricks/driver/RC_T_MAIN_DATA_01.zip

# COMMAND ----------

# MAGIC %fs
# MAGIC cp file:/databricks/driver/RC_T_MAIN_DATA_01.csv dbfs:/RC/MSATER_DATA_FILES

# COMMAND ----------

# MAGIC %sh
# MAGIC unzip RC_T_MAIN_DATA_01.zip

# COMMAND ----------

# MAGIC %fs
# MAGIC cp file:/databricks/driver/RC_T_MAIN_DATA_01.csv dbfs:/mnt/Exploratory/WCLD/dataset/RC_T_MAIN_DATA_01.csv
...
# %sh
# mkdir RCPredictiveMA/img/trend
...
hdfsPathCSV = "dbfs:/RC/MSATER_DATA_FILES/RC_T_MAIN_DATA_01.csv"

# COMMAND ----------

# MAGIC %sh
# MAGIC mkdir RC_T_MAIN_DATA_01
...
def replaceByMedian(pySparkDF, columnList):
    for colName in columnList:
        ...
        pySparkDF = pySparkDF.withColumn(colName, when(pySparkDF[colName]>8888888,None).otherwise(pySparkDF[colName]))
...
sequence_length = 720
# sampleEvent = sampleEvent[sampleEvent['EVENT_ID']==6858]
# sampleEvent = sampleEvent.sort_values(['CYCLE'])
...
sampleEvent = spark.sql("select * from rc_data where EVENT_ID=6858 order by cycle")
...
colNameSet1 =['LUBE_OIL_PRESS', 'LUBE_OIL_TEMP', 'THROW_1_DISC_PRESS', 'THROW_1_DISC_TEMP', 'THROW_1_SUC_PRESS', 'THROW_1_SUC_TEMP', 'THROW_2_DISC_PRESS', 'THROW_2_DISC_TEMP', 'THROW_2_SUC_TEMP', 'THROW_3_DISC_PRESS',
'THROW_3_DISC_TEMP', 'THROW_3_SUC_PRESS', 'THROW_3_SUC_TEMP', 'THROW_4_DISC_PRESS', 'THROW_4_DISC_TEMP', 'VIBRATION']

colNameSet2 = ['CYL_1_TEMP', 'CYL_2_TEMP', 'CYL_3_TEMP', 'CYL_4_TEMP', 'CYL_5_TEMP', 'CYL_6_TEMP', 'CYL_7_TEMP', 'CYL_8_TEMP', 'CYL_9_TEMP', 'CYL_10_TEMP', 'CYL_11_TEMP','LUBE_OIL_PRESS_ENGINE', 'SPEED']
...
engineSample50Set1 = engineSample50cycleWindow[colNameSet1]
engineSample50Set2 = engineSample50cycleWindow[colNameSet2]

# COMMAND ----------

# plotting sensor data for engine ID 3 prior to a failure point - sensors 1-10 
ax1 = engineSample50Set1.plot(subplots=True, sharex=True, figsize=(15,15))
#ax1.set_title('Sensor Value from Last 1,440 Time Step Before Failure')
#ax1.set_xlabel('Cycle 1 Min|ute Per Step')
...
# plotting sensor data for engine ID 3 prior to a failure point - sensors 1-10 
ax1 = engineSample50Set2.plot(subplots=True, sharex=True, figsize=(15,15))
#ax1.set_title('Sensor Value from Last 1,440 Time Step Before Failure')
...
data = sampleEvent['THROW_1_DISC_PRESS', 'THROW_1_DISC_TEMP', 'THROW_1_SUC_PRESS', 'THROW_1_SUC_TEMP', 'THROW_2_DISC_PRESS']
scatter_matrix(data, alpha=0.2, figsize=(6, 6), diagonal='kde')

#engineSample50Set1['THROW_1_SUC_PRESS'].diff().hist()
#engineSample50Set1['THROW_1_SUC_PRESS'].hist(by=randint(0, 4, 1000), figsize=(6, 4))
display()
